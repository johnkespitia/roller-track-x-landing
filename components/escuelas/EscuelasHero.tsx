...
export default function EscuelasHero() {
  return (
    <section className="relative overflow-hidden bg-dark pt-28 pb-20 md:pt-36 md:pb-28">
      ...
      <div className="absolute bottom-0 left-0 w-[360px] h-[360px] bg-neon-purple/10 rounded-full blur-[120px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Para Escuelas
            <br />
            <span className="text-gradient-primary">y Clubes</span>
          </motion.h1>
          ...
          >
            ...
            dentro del ecosistema del patinaje.
          </motion.p>
          ...
          >
            <CTAButton href="#beneficios" variant="glow" size="lg" ctaType="school">
              Ver beneficios
            </CTAButton>
            <CTAButton
              href="#formulario"
